...
import { require_classnames, useBootstrapPrefix, useIsRTL } from "./ThemeProvider-BBQ9NGxT.js";
import { addEventListener_default, contains, listen_default, ownerDocument, useEventCallback, useIsomorphicEffect_default, useMergedRefs_default, useWindow } from "./useMergedRefs-31ITgepp.js";
import { dataAttr, qsa, useEventCallback as useEventCallback$1, useMounted, usePrevious } from "./querySelectorAll-B9rhTCoL.js";
import { require_jsx_runtime } from "./jsx-runtime-B203huS-.js";
import { require_warning } from "./warning-DGWU09zh.js";
import { Button_default as Button_default$1 } from "./Button-Y2Q-jOjs.js";
import { Button_default } from "./Button-BuBISSOY.js";
import { InputGroupContext_default } from "./InputGroupContext-COolY1fW.js";
import { NavbarContext_default, SelectableContext_default, makeEventKey, require_browser, useUncontrolled } from "./NavbarContext-Dokhnp7Z.js";
import { Anchor_default, NavContext_default, NavLink_default, useCallbackRef, useEventListener, useForceUpdate } from "./NavLink-Cmw-5g6-.js";
...
function useDropdownMenu(options = {}) {
	const context = (0, import_react.useContext)(DropdownContext_default$1);
	const [arrowElement, attachArrowRef] = useCallbackRef();
	const hasShownRef = (0, import_react.useRef)(false);
	const { flip: flip$1, offset: offset$1, rootCloseEvent, fixed = false, placement: placementOverride, popperConfig = {}, enableEventListeners = true, usePopper: shouldUsePopper = !!context } = options;
...
var DropdownToggle = /* @__PURE__ */ import_react.forwardRef(({ bsPrefix, split, className, childBsPrefix, as: Component = Button_default,...props }, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {
		className: (0, import_classnames$2.default)(className, prefix, split && `${prefix}-split`, (dropdownContext == null ? void 0 : dropdownContext.show) && "show"),
		...toggleProps,
		...props
	});
});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownContext_default.Provider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dropdown_default$1, {
			...
			children: isInputGroup ? props.children : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {
				...props,
				ref,
				className: (0, import_classnames$1.default)(className, show && "show", directionClasses[drop])
			})
		})
	});
});

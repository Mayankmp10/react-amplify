...
import { FormCheckInput_default, FormContext_default } from "./FormCheckInput-Dj4YL5JN.js";
import { require_warning } from "./warning-DGWU09zh.js";
import { Col_default } from "./Col-NR2TXZFf.js";
...
var Feedback = /* @__PURE__ */ import_react.forwardRef(({ as: Component = "div", className, type = "valid", tooltip = false,...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {
	...props,
	ref,
	className: (0, import_classnames$10.default)(className, `${type}-${tooltip ? "tooltip" : "feedback"}`)
}));
...
var FormCheckLabel = /* @__PURE__ */ import_react.forwardRef(({ bsPrefix, className, htmlFor,...props }, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
		...
		className: (0, import_classnames$9.default)(className, bsPrefix)
	});
});
...
var FormCheck = /* @__PURE__ */ import_react.forwardRef(({ id, bsPrefix, bsSwitchPrefix, inline = false, reverse = false, disabled = false, isValid = false, isInvalid = false, feedbackTooltip = false, feedback, feedbackType, className, style, title = "", type = "checkbox", label, children, as = "input",...props }, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormContext_default.Provider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			style,
			className: (0, import_classnames$8.default)(className, hasLabel && bsPrefix, inline && `${bsPrefix}-inline`, reverse && `${bsPrefix}-reverse`, type === "switch" && bsSwitchPrefix),
...
var FormControl = /* @__PURE__ */ import_react.forwardRef(({ bsPrefix, type, size, htmlSize, id, className, isValid = false, isInvalid = false, plaintext, readOnly, as: Component = "input",...props }, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {
		...
		readOnly,
		id: id || controlId,
		className: (0, import_classnames$7.default)(className, plaintext ? `${bsPrefix}-plaintext` : bsPrefix, size && `${bsPrefix}-${size}`, type === "color" && `${bsPrefix}-color`, isValid && "is-valid", isInvalid && "is-invalid")
	});
});

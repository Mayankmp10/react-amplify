...
import { require_classnames, useBootstrapPrefix } from "./ThemeProvider-BBQ9NGxT.js";
import { canUseDOM_default, contains, listen_default, ownerDocument, useEventCallback, useIsomorphicEffect_default as useIsomorphicEffect_default$1, useMergedRefs_default, useWindow } from "./useMergedRefs-31ITgepp.js";
import { require_react_dom } from "./react-dom-B2lIHbZY.js";
import { _inheritsLoose, _objectWithoutPropertiesLoose, dataAttr, qsa, useEventCallback as useEventCallback$1, useIsomorphicEffect_default, useMounted, usePrevious } from "./querySelectorAll-B9rhTCoL.js";
import { useMergedRefs_default as useMergedRefs_default$1 } from "./useMergedRefs-CaoDBEvr.js";
import { require_jsx_runtime } from "./jsx-runtime-B203huS-.js";
import { require_prop_types } from "./prop-types-BYyobYcv.js";
...
function useRTGTransitionProps(_ref) {
	let { onEnter, onEntering, onEntered, onExit, onExiting, onExited, addEndListener, children } = _ref, props = _objectWithoutPropertiesLoose$3(_ref, _excluded$2);
...
var RTGTransition = /* @__PURE__ */ import_react.forwardRef((_ref, ref) => {
	let { component: Component } = _ref, props = _objectWithoutPropertiesLoose$2(_ref, _excluded$1);
...
var Modal = /* @__PURE__ */ (0, import_react.forwardRef)((_ref, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: /* @__PURE__ */ import_react_dom$2.createPortal(/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [backdropElement, dialog] }), container) });
});
...
var Fade = /* @__PURE__ */ import_react.forwardRef(({ className, children, transitionClasses = {}, onEnter,...rest }, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TransitionWrapper_default, {
		...
		children: (status, innerProps) => /* @__PURE__ */ import_react.cloneElement(children, {
			...innerProps,
			className: (0, import_classnames$7.default)("fade", className, children.props.className, fadeStyles[status], transitionClasses[status])
		})
	});
});
...
var OffcanvasToggling = /* @__PURE__ */ import_react.forwardRef(({ bsPrefix, className, children, in: inProp = false, mountOnEnter = false, unmountOnExit = false, appear = false,...props }, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TransitionWrapper_default, {
		...
		children: (status, innerProps) => /* @__PURE__ */ import_react.cloneElement(children, {
			...innerProps,
			className: (0, import_classnames$5.default)(className, children.props.className, (status === ENTERING || status === EXITING) && `${bsPrefix}-toggling`, transitionStyles[status])
		})
	});
});
...
var CloseButton = /* @__PURE__ */ import_react.forwardRef(({ className, variant, "aria-label": ariaLabel = "Close",...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
	ref,
	type: "button",
	className: (0, import_classnames$4.default)("btn-close", variant && `btn-close-${variant}`, className),
...
var divWithClassName_default = ((className) => /* @__PURE__ */ import_react.forwardRef((p, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
	...p,
	ref,
	className: (0, import_classnames$2.default)(p.className, className)
})));
...
//#endregion
export { ENTERED, ENTERING, EXITED, EXITING, Offcanvas_default, TransitionWrapper_default, css_default, getChildRef, transitionEndListener, triggerBrowserReflow };
//# sourceMappingURL=Offcanvas-BGsIxrKv.js.map